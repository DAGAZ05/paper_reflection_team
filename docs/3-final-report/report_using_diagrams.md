...
![01-system-architecture](diagrams/01-system-architecture.png)

系统的核心处理流程是一个五阶段顺序流水线，每个阶段的输出作为下一阶段的输入。这种流水线设计保证了数据处理的有序性和可追溯性。以下是系统处理单篇论文的完整流程图：

![02-process-flow](diagrams/02-process-flow.png)
...
![03-er-diagram](diagrams/03-er-diagram.png)
...
![04-check-logic-dataflow](diagrams/04-check-logic-dataflow.png)
...
![05-conflict-sequence](diagrams/05-conflict-sequence.png)

冲突裁决模块的状态转换图如下所示：

![06-conflict-state](diagrams/06-conflict-state.png)
...
![07-evidence-validation](diagrams/07-evidence-validation.png)
...
![08-deduplication](diagrams/08-deduplication.png)
...
![09-dialogue-sequence](diagrams/09-dialogue-sequence.png)
...
![10-system-dataflow](diagrams/10-system-dataflow.png)
